...
public class SpringDataExample {
    ...
    private static RedisConnectionFactory lettuceFactorySentinel() {
        RedisSentinelConfiguration sentinelConfig = new RedisSentinelConfiguration().master("mymaster").sentinel("127.0.0.1", 26379).sentinel("127.0.0.1", 26380).sentinel("127.0.0.1", 26381);
    ...
    private static RedisConnectionFactory lettuceFactoryCluster() {
        LettuceConnectionFactory f = new LettuceConnectionFactory(new RedisClusterConfiguration(Arrays.asList("127.0.0.1:7000", "127.0.0.1:7001", "127.0.0.1:7002")));
        f.afterPropertiesSet();
        return f;
    }
